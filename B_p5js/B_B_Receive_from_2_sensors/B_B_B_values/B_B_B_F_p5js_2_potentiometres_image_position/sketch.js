...
var monImage;
var positionImageX, posiitonImageY;
...
function draw() {
  ...
  image(monImage, positionImageX, positionImageY);
...
function serialEvent() {
  ...
  positionImageX = map( sensors[0], 0, 1023, 10, width-10);
  positionImageY = map( sensors[1], 0, 1023, 10, height-10);
}
